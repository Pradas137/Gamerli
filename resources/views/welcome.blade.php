    ...
    <body >
        <main>
            <div class="sm:flex md:flex lg:flex xl:flex justify-center items-center min-h-screen bg-base">
                <div style="background-image: url(/images/fondonegro.jpg)" class="bg-auto bg-no-repeat bg-center sm:flex md:flex lg:flex xl:flex h-50 container bg-admin text-center w-2/4 rounded-xl p-5 shadow-xl">
