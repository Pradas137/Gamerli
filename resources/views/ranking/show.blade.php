    ...
    <div class=" bg-gray-600 h-8 md:h-full border-r w-64 text-center border-gray-200">
        ...
        <div class="-mx-3 md:flex mt-2">
            <div class="md:w-full px-10">
                <a href="/admin/dashboard/ranking/index" class="md:w-full bg-gray-900 text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 border-gray-500 hover:border-gray-100 rounded-full">
                        Atras
                </a>
            </div>
        </div>
