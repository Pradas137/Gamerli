        ...
        <form method="POST" action="{{ route('ranking.store') }}">
            ...
            <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                ...
                <div class="-mx-3 md:flex mb-6">
                    ...
                    <div class="md:w-full px-10">
                        <a href="/dashboard/rankinge" class="md:w-full bg-gray-900 text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 border-gray-500 hover:border-gray-100 rounded-full">
                        Atras
                        </a>
                    </div>
                </div>
