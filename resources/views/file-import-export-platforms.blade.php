<x-app-layout page="">
    ...
    <div class="flex h-screen">
        ...
        <h1 class="text-center text-green-600 text-5xl font-bold"> Import Platform </h1>
                ...
                <form action="{{ route('file-import-platforms') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-4" style="max-width: 500px; margin: 0 auto;">
                        <div class="text-center md:w-1/2 px-3">
                            <label class=" font-bolt mb-4 uppercase tracking-wide text-black text-2xl font-bold mb-2" for="customFile">Platform file</label>
